...
//			$breadcrumbs[] = array(0=>$data->title, 1 => '');	
			...
			$link_news = FSRoute::_("index.php?module=news&view=news&id=".$data->id."&code=".$data->alias."&ccode=".$data-> category_alias);
        	$tmpl -> assign ( 'canonical',$link_news);
        	$tmpl -> load_amp(1, 0,'','','',FSRoute::_('index.php?module=news&view=amp_news&code='.$data->alias.'&id='.$data->id.'&ccode='.$data->category_alias.'&Itemid=50'));
			// seo
