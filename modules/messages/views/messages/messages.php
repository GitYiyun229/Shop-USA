...
<div class="frame_display  messages">
	...
	<div class="frame_body">
		<div class="form_head">
			<p class="title">
			<a class="button4" href="<?php echo Route::_('index.php'); ?>" ><span>Soạn tin mới <img alt="a" src="<?php echo  URL_ROOT.'images/arrow-r.gif'; ?>" /> </span></a>
			<?php if($task == 'inbox') {?>
				<a class="button4" href="<?php echo Route::_('index.php'); ?>" ><span> Tin đã nhận <img alt="a" src="<?php echo  URL_ROOT.'images/arrow-b.gif'; ?>" /> </span></a>
			<?php } else { ?>
				<a class="button4" href="<?php echo Route::_('index.php'); ?>" ><span> Tin đã nhận <img alt="a" src="<?php echo  URL_ROOT.'images/arrow-b.gif'; ?>" /> </span></a>
			<?php }?>
			<a class="button4" href="<?php echo Route::_('index.php'); ?>" ><span> Tin đã gửi <img alt="a" src="<?php echo  URL_ROOT.'images/arrow-r.gif'; ?>" /> </span></a>
			</p>		
		</div>	
		<div class="form_body">
